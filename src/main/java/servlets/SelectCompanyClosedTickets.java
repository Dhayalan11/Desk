...
/**
 * Servlet implementation class SelectCompanyClosedTickets
 */
@WebServlet("/SelectCompanyClosedTickets")
public class SelectCompanyClosedTickets extends HttpServlet {
	
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<Ticket> arrList = AccessTicket.getClosedTicket();
