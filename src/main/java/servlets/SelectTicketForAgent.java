...
/**
 * Servlet implementation class SelectTicketForAgent
 */
@WebServlet("/SelectTicketForAgent")
public class SelectTicketForAgent extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Ticket> arrList = AccessTicket.getSomeTicket(email);
