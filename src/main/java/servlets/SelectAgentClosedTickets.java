...
/**
 * Servlet implementation class SelectAgentClosedTickets
 */
@WebServlet("/SelectAgentClosedTickets")
public class SelectAgentClosedTickets extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Ticket> arrList = AccessTicket.getAgentClosedTicket(email);
