...
/**
 * Servlet implementation class SelectCompanyEscalatedTicket
 */
@WebServlet("/SelectCompanyEscalatedTicket")
public class SelectCompanyEscalatedTicket extends HttpServlet {
	
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<Ticket> arrList = AccessTicket.getEscalatedTicket();
