...
/**
 * Servlet implementation class SelectCompanyOpenTicket
 */
@WebServlet("/SelectCompanyOpenTicket")
public class SelectCompanyOpenTicket extends HttpServlet {

	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		List<Ticket> arrList = AccessTicket.getOpenTicket();
