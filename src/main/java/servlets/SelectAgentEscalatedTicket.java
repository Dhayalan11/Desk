...
/**
 * Servlet implementation class SelectAgentEscalatedTicket
 */
@WebServlet("/SelectAgentEscalatedTicket")
public class SelectAgentEscalatedTicket extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Ticket> arrList = AccessTicket.getAgentEscalatedTicket(email);
